...
const ThankYouScreen = (props) => {
    ...
    const renderServices = () => (
        <MDBRow className={css`text-align: center;`}>
            ...
            {!!(mixedCategories && mixedCategories[0]) && (<MDBCol md="2" className={css`${props?.displayType?.isTabletOrMobile && "width: 60%; height: 44vh; margin-bottom: 5%; margin-left: 20%;"} background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url("${mixedCategories[0]?.image}"); border-radius: 10vh; padding-top: 7.75%; padding-bottom: 4%;`}>
            ...
            {!!(mixedCategories && mixedCategories[1]) && (<MDBCol md="2" className={css`${props?.displayType?.isTabletOrMobile && "width: 60%; height: 44vh; margin-bottom: 5%; margin-left: 20%;"} background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url("${mixedCategories[1]?.image}"); border-radius: 10vh; padding-top: 7.75%; padding-bottom: 4%;`}>
            ...
            {!!(mixedCategories && mixedCategories[2]) && (<MDBCol md="2" className={css`${props?.displayType?.isTabletOrMobile && "width: 60%; height: 44vh; margin-bottom: 5%; margin-left: 20%;"} background-position: center; background-repeat: no-repeat; background-size: cover; background-image: url("${mixedCategories[2]?.image}"); border-radius: 10vh; padding-top: 7.75%; padding-bottom: 4%;`}>
